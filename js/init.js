		...
		plugins: {
			layers: {
				...
				titleBar: {
					breakpoints: 'narrower',
					height: 44,
					html: '<span class="toggle" data-action="toggleLayer" data-args="navPanel"></span><span class="title" data-action="copyHTML" data-args="logo">Counselling Service, IITK</span>',
					position: 'top-left',
					side: 'top',
					width: '100%'
				}
